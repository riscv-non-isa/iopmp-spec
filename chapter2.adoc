...
// NOTE: This paragraph was simplified as part of the specification simplification.
// Only memory region and the corresponding permissions are in the paragraph.
