...
`ENTRY_CFG(_i_)` contains the basic permission fields for read, write, instruction fetch and address mode configuration.
...
<<EXAMPLE_RRID2ENTRY>> illustrates an example of relations between RRIDs, memory domains, and IOPMP entries. In the example, RRID 0 is associated with entry 0, 1, 2, 5, 6, and RRID 1 is associated with entry 0, 1, 2, 3, 4.
