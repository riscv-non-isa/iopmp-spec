...
static struct iopmp_operations_specific iopmp_operations_rapid_k = {
...
const struct iopmp_driver iopmp_drv_rapid_k;

static enum iopmp_error iopmp_drv_rapid_k_init(IOPMP_t *iopmp, uintptr_t addr)
{
    return iopmp_drv_init_common(iopmp, addr,
                                 iopmp_drv_rapid_k.srcmd_fmt,
                                 iopmp_drv_rapid_k.mdcfg_fmt,
                                 &iopmp_operations_rapid_k);
}
