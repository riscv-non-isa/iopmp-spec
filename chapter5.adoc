...
|{set:cellbgcolor:#FFFFFF} svc   |7:7    |R      |0          |Indicate there is a subsequent violation caught in *ERR_MFR*. The field is always valid even after clearing *REQ_ERRINFO.v* and can be updated during *v* = 1.
