...
|{set:cellbgcolor:#FFFFFF}fault_mode  |3:3  |WARL   |IMP        | When MDSTALL is set, fault the transactions if the corresponding RRID is not exempt.
...
|{set:cellbgcolor:#FFFFFF} etype     |7:3   |R      |0          a| {set:cellbgcolor:#FFFFFF} Indicated the type of violation
