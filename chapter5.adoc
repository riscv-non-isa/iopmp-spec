...
| - | Other regions in offset 0x0000 to 0x0800 are reserved.
...
|{set:cellbgcolor:#FFFFFF} - |Other regions in offset 0x0800 to 0x1000 are reserved.
...
|{set:cellbgcolor:#FFFFFF} - |Other regions in offset 0x1000 to ENTRYOFFSET are reserved.
