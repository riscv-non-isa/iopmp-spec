...
| xinr               | 0/1                       | Indicates whether the IOPMP treats the instruction fetch
accesses as data read accesses.<br />**0**: Fields of instruction fetches are not ignored<br />**1**: Fields of instruction fetches are ignored |
...
| imp_msi            | 0/1                       | Indicates if Messaged-Signal-Interrupts are supported.<br />**0:** MSI is not supported.<br />**1:** MSI can be generated.                                                                                                           |
