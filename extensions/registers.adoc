...
.9+|0x0010 .9+|HWCFG2      |prio_entry     |15:0  .3+|<<NON_PRIORITY_ENTRIES>>
                           |prio_ent_prog  |16:16
                           |non_prio_en    |17:17 
                           |chk_x          |26:26    |<<X_PERM>>
                           |pies           |27:27 .2+|<<PEIS_PEES>>
                           |pees           |28:28
                           |sps_en         |29:29    |<<SRCMD_EXT>>
...
3+h|SRCMD Table, _m_ = 0...*HWCFG0.md_num*-1, _s_ = 0...*HWCFG1.rrid_num*-1.
  h|Offset           h|Register          h|Related section(s)
   |0x1008 + (_s_)*32 |SRCMD_R(_s_)    .4+|<<SRCMD_EXT>>
...
|ie                               |1:1    |WARL   |0          |Enable the interrupt of the IOPMP rule violation.
|rs                               |2:2    |WARL   |0         a| 
