...
This section introduces an extension to stall transations by RRIDs and describes how to use the extension to update IOPMP's settings safely in runtime.
