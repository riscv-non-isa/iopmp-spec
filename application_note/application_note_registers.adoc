...
.8+|0x0014 .8+|HWCFG3 |mdcfg_fmt |1:0 .2+|<<mdcfg-table-formats, MDCFG Table Reduction>>
                     |md_entry_num |11:4
                     |srcmd_fmt |3:2 |<<srcmd-table-formats, SRCMD Table Reduction>>
                     ...
                     |rrid_transl |31:16
  |0x1000 + (_m_) × 32 |SRCMD_PERM(_m_) 2+|All .2+|<<SRCMD_Table_Extension, SRCMD Table Extension>>
  |0x1004 + (_m_) × 32 |SRCMD_PERMH(_m_) 2+|All
|===
