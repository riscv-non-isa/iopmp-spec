...
|rrid_transl                     |31:16    |RW   |IMP          |The RRID tagged to outgoing transactions. Support only for `HWCFG3.rrid_transl_en`=1. It is writable only when `HWCFG3.rrid_transl_prog`=1.
|===
